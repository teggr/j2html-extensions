...
public class Grid {
    ...
    public static final String row_cols_7 = "row-cols-7";

    public static final String row_cols_8 = "row-cols-8";

    public static final String row_cols_9 = "row-cols-9";

    public static final String row_cols_10 = "row-cols-10";

    public static final String row_cols_11 = "row-cols-11";

    public static final String row_cols_12 = "row-cols-12";
